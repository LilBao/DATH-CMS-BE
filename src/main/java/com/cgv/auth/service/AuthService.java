package com.cgv.auth.service;

import com.cgv.auth.dto.*;
import com.cgv.auth.factory.AuthProviderFactory;
...
import com.cgv.repository.customer.MembershipRepository;
    ...
    public JwtResponse register(RegisterRequest request) {
        ...
        Customer customer = Customer.builder()
                ...
                .sex(request.getSex() != null ?
                        com.cgv.entity.customer.Customer.Sex.valueOf(request.getSex()) : null)
